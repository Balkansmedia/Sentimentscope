...
tree = ET.parse(r"C:\Users\aleks\OneDrive\Desktop\sentiment-scope\novelty-detection-main\novelty-detection-main\allowed.xml")
...
def main():
    ...
    for j in range(0, 300): 
        ...
        line = toLower(line)
        with open('allowed/' + str(lineCounter) + '.txt', 'w', encoding="utf-8") as generatedTxtFile: 
